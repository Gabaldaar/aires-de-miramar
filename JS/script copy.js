...
document.querySelectorAll('.carousel').forEach(carousel => {
  ...
  document.getElementById('btn-elegi-destino').addEventListener('click', function() {
    const ficha = document.getElementById('fichas-propiedades'); // Cambiá por el id real de la sección de fichas
    if (ficha) {
      ficha.scrollIntoView({ behavior: 'smooth', block: 'start' });
    }
  });
    document.getElementById('btn-elegi-destino').addEventListener('click', function() {
    const ficha = document.getElementById('fichas-propiedades');
    if (ficha) {
      ficha.scrollIntoView({ behavior: 'smooth', block: 'start' });
    }
  });